...
enum class Type : char {
   ...
   arrow, l_paren, r_paren, l_brace, r_brace, l_bracket, r_bracket, comma, semicolon
};
...
static std::unordered_map<std::string_view, Type> operators {
   ...
   {"->", Type::arrow}, {"(", Type::l_paren}, {")", Type::r_paren}, {"{", Type::l_brace}, {"}", Type::r_brace}, {"[", Type::l_bracket}, {"]", Type::r_bracket}, {",", Type::comma}, {";", Type::semicolon}
};

static std::unordered_set<std::string_view> keywords {
   "let", "con", "delete", "exists", "sizeof",
